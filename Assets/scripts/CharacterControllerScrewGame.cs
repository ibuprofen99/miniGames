...
public class CharacterControllerScrewGame : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        animator.speed = Mathf.Max(1f, speed / 30f); // Change animation speed based on 1/3 maxRotationSpeed value, minimum animation speed must be 1 or else it'll look funky
    }
}
